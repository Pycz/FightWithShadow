...
namespace Epsilon {
	internal class Gun {
		...
		/// <summary>включение таймера на заданное время
		/// </summary>
		/// <param name="x"></param>
		internal void TurnOnTimer(int x) {
			m_roketTimer = x;
		}
